/*! \file flat.vert
 *
 * Project 1 vertex shader for basic rendering without lighting.
 *
 * \author John Reppy
 */
...
layout (location = 0) out vec3 color;   //!< output color

void main ()
{
    gl_Position = ubo.P * ubo.viewM * pconsts.toWorld * vec4(vPos, 1);
    color = pconsts.color;
}
