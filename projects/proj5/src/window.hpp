...
/// the period between simulation steps (60 FPS)
...
/// The Project 5 Window class
class Proj5Window : public cs237::Window {
public:
    Proj5Window (Proj5 *app);

    ~Proj5Window () override;
...
private:
    ...
    /** HINT: define resources for the particle system */
    /** NOTE: the enable/disable state and timing support for the particle system
    ...
    void _recordForwardCommands (Proj5Window::FrameData *frame);
    ...
    {
        return reinterpret_cast<Proj5 *>(this->_app)->scene();
    }
