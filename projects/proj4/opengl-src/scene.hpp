...
class Scene {
  ...
  //! return the name of the scene
    std::string const &Name() const { return this->name; }
  ...
  //! load a 2D texture from a named image file
  //! \param name the name of the texture source image file
  ...
  private:
    ...
    std::map<std::string, cs237::texture2D *> _texs;
                                                //!< 2D textures keyed by name

  // helper function for pre-loading textures into the _texs map
