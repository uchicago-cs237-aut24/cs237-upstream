...
class WireframeRenderer : public RenderPass {
  public:
    ...
    void Render (cs237::mat4f const &projMat, cs237::mat4f const &viewMat, const Instance *mesh);
...
class TexturingRenderer : public RenderPass {
  ...
  // uniform variable locations for lighting
    ...
    int                 _emissiveSrcLoc;
    int                 _emissiveCLoc;
    int                 _emissiveMapLoc; //!< the location of the diffuse texture-mapping flag
