...
Mesh::Mesh (Proj4 *app, OBJ::Model const *model, int grpId)
: device(app->device()),
...
void TextureProperty::define (Proj4 *app, cs237::Image2D *img)
{
...
MeshFactory::MeshFactory (Proj4 *app, int nMeshes)
: _app(app)
{
